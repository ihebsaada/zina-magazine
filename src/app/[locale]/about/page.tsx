...
const content = {
  ...
  ar: {
    ...
    vision: "رؤيتنا",
    visionText:
      "تأسست إكس ميديا على فرضية بسيطة: في عصر التصفح اللانهائي والاهتمام السطحي، هناك تعطش عميق للقصص المنسقة وذات المغزى. نحن نؤمن بأن الإعلام الرقمي يمكن أن يكون أنيقاً، ملموساً ودائماً تماماً كالمطبوعات. صُممت صفحاتنا لتدع العقل يتنفس والعين تتأمل.",
    identity: "هويتنا",
    identityText:
      "نحن نسد الفجوة بين التصميم المعاصر، الحياة الواعية، والتراث الثقافي. بدءاً من المبدعين المستقلين إلى الأصوات الراسخة، نحن نرتقي بالسرديات التي تغير وجهات النظر. نحن لسنا مجرد مجلة؛ نحن أرشيف للأناقة الحديثة.",
  },
};
